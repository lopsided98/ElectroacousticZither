...
enum midi_command_sysex {
	...
	MIDI_COMMAND_SYSEX_ATTACK_TIME = 0x43,
	MIDI_COMMAND_SYSEX_RELEASE_TIME = 0x44,
	MIDI_COMMAND_SYSEX_ATTACK_AMPLITUDE = 0x45,
	MIDI_COMMAND_SYSEX_SUSTAIN_AMPLITUDE = 0x46,
	MIDI_COMMAND_SYSEX_RELEASE_AMPLITUDE = 0x47,
};

uint8_t MIDI_NOTE_OCTAVE_OFFSET;
...
enum midi_note {
	...
	MIDI_NOTE_G3 = 55,
	MIDI_NOTE_A3 = 57,
	MIDI_NOTE_A_SHARP3 = 58,
	MIDI_NOTE_B_FLAT3 = 58,
	MIDI_NOTE_B3 = 59,
	MIDI_NOTE_C4 = 60,
	MIDI_NOTE_D4 = 62,
	MIDI_NOTE_E4 = 64,
	...
	MIDI_NOTE_G4 = 67,
	MIDI_NOTE_A4 = 69,
	MIDI_NOTE_A_SHARP4 = 70,
	MIDI_NOTE_B_FLAT4 = 70,
	MIDI_NOTE_B4 = 71,
	MIDI_NOTE_C5 = 72,
	MIDI_NOTE_D5 = 74,
	MIDI_NOTE_E5 = 76,
