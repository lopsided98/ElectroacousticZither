...
# Pmod Header JB
# Sch name = JB7
set_property -dict {PACKAGE_PIN A15 IOSTANDARD LVCMOS33} [get_ports midi_uart_rxd]
# Sch name = JB8
set_property -dict {PACKAGE_PIN A17 IOSTANDARD LVCMOS33} [get_ports midi_uart_txd]
